...
const raisedToTheThird = (arr) => {
  ...
  arr.forEach(number => {
    newNumbers.push(Math.pow(number, 3));
  });
  return newNumbers;
};
...
const addOne = (arr) => {
  ...
  let addOneNumber = [];
  arr.map(number => {
    addOneNumber.push(number + 1);
  });
  return addOneNumber;
};

//   arr.map(number => {
//     numberAddOne.push(number.toStrictEqual ++);
//   });
//   return numberAddOne;
// };
...
const forLoopTwoToThe = (arr) => {
  // Solution code here...
  const newToThePowerTwo = [];
  for( let t = 0; t < arr.length; t++) {
    newToThePowerTwo.push(Math.pow(2, arr[t]));
  }
  return newToThePowerTwo;
};
...
const forEachTwoToThe = (arr) => {
  ...
  const raiseToTheTwo = [];
  arr.forEach(number => {
    raiseToTheTwo.push(Math.pow(2, number));
  });
  return raiseToTheTwo;
};
...
const mapTwoToThe = (arr) => {
  ...
  const newTwoToThe = [];
  arr.map(number => {
    newTwoToThe.push(Math.pow(2, number));
  });
  return newTwoToThe;
};
