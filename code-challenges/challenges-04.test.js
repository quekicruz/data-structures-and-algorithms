...
const updateAnimal = (arr, callback) => {
  // Solution code here...
  const updateAnimalArray = arr.map((animal) => {
    return callback(animal);
  });
  return updateAnimalArray;
};
...
const sortNumbers = (arr) => {
  // Solution code here...
  const smallToHighArray = arr.sort((a,b) => {
    if(a>b){
      return 1;
    }else if(a<b) {
      return -1;
...
const sortBackwards = (arr) => {
  // Solution code here...
  const sortForwardArray = arr.sort ((a,b) => {
    if(a<b) {
      return 1;
    }else if(a>b){
      return -1;
...
const alphabetize = (arr) => {
  // Solution code here...
  const newWordOrderArray = arr.sort((a,b) => {
    if(a>b){
      return 1;
    }else if(a<b){
      return -1;
...
const sortByPrice = (arr) => {
  // Solution code here...
  const priceLowToHighArray = arr.sort((a,b) => {
    if(a.price>b.price){
      return 1;
...
const alphabetizeBetter = (arr) => {
  // Solution code here...
  const alphabeatBetter = arr.sort((a,b) => {
    if(a>b){
      return 1;
    }else{
      return 0;
