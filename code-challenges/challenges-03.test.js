...
const typeNum = (arr) => {
  // Solution code here...
  const typeNumArray = arr.filter(number => {
...
const containsAnd = (arr) => {
  // Solution code here...
  const containsAndArray = arr.filter(number => {
    if (number.includes ('and')) {
      return true;
    }
    return false;
  });
...
const oddValues = (arr) => {
  // Solution code here...
  const oddValuesArray = arr.filter (number => {
    if (number % 2 !== 0 ) {
      return true;
    }
    return false;
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  const newInFirstArray = arr.filter(number => {
    if(!forbiddenValues.includes(number)) {
      return true;
    }
    return false;
  });
  return newInFirstArray;
};
