...
const toLastNames = people => {
  // Solution code here...
  const namesTogetherArray = [];
  people.map((names) => {
    namesTogetherArray.push(names.firstName + ' ' + names.lastName);
  });
  return namesTogetherArray;
};
...
const addValues = (arr) => {
  // Solution code here...
  const newNumberArry = arr.reduce((acc, number) => {
    return acc + number;
  }, 0);
...
const addPurchases = (arr) => {
  // Solution code here...
  const totalPriceArray = arr.reduce((acc, number) => {
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  const totalElementsArray = arr.reduce((acc, number) => {
    return number;
  }, 0);
  return totalElementsArray;
};
...
const returnNames = (arr) => {
  // Solution code here...
  const characterNameArray = arr.reduce((acc, number) => {
...
const reversedString = (str) => {
  // Solution code here...
  const weirdString = str.split('');
  const updatedStringArray = weirdString.reduce((acc, string) => {
    return acc + string;
  }, '');
